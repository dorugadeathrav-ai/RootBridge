const indiaDistricts = {
  ...
  Assam: [
    ...
    'Lakhimpur', 'Majuli', 'Marigaon', 'Nagaon', 'Nalbari', 'Sivasagar',
  ...
  Maharashtra: [
    ...
    'Nandurbar', 'Nashik', 'Chhatrapati Sambhajinagar', 'Dharashiv', 'Palghar', 'Parbhani', 'Pune', 'Raigad',
  ...
  Punjab: ['Amritsar', 'Barnala', 'Bathinda', 'Faridkot', 'Fatehgarh Sahib', 'Fazilka', 'Firozpur', 'Gurdaspur', 'Hoshiarpur', 'Jalandhar', 'Kapurthala', 'Ludhiana', 'Malerkotla', 'Mansa', 'Moga', 'Pathankot', 'Patiala', 'Rupnagar', 'Sahibzada Ajit Singh Nagar', 'Sangrur', 'Shaheed Bhagat Singh Nagar', 'Shri Muktsar Sahib', 'Tarn Taran'],
  Rajasthan: ['Ajmer', 'Alwar', 'Anupgarh', 'Balotra', 'Banswara', 'Baran', 'Barmer', 'Beawar', 'Bharatpur', 'Bhilwara', 'Bikaner', 'Bundi', 'Chittorgarh', 'Churu', 'Dausa', 'Deeg', 'Dholpur', 'Didwana-Kuchamana', 'Dudu', 'Dungarpur', 'Gangapur City', 'Hanumangarh', 'Jaipur', 'Jaisalmer', 'Jalore', 'Jhalawar', 'Jhunjhunu', 'Jodhpur', 'Karauli', 'Kekri', 'Khairthal-Tijara', 'Kota', 'Kotputli-Behror', 'Nagaur', 'Neem Ka Thana', 'Pali', 'Phalodi', 'Pratapgarh', 'Rajsamand', 'Sawai Madhopur', 'Salumbar', 'Sanchore', 'Shahpura', 'Sikar', 'Sirohi', 'Sri Ganganagar', 'Tonk', 'Udaipur'],
...
type CityVillageMap = Record<string, readonly string[]>
export type LocationHierarchy = Record<string, Record<string, CityVillageMap>>

const maharashtraTalukas: Record<string, CityVillageMap> = {
  Kolhapur: {
    Karvir: ['Kolhapur', 'Other Village'],
    Panhala: ['Panhala', 'Other Village'],
    Shahuwadi: ['Shahuwadi', 'Other Village'],
    Kagal: ['Kagal', 'Other Village'],
    Hatkanangale: ['Hatkanangale', 'Other Village'],
    Shirol: ['Shirol', 'Other Village'],
    Radhanagari: ['Radhanagari', 'Other Village'],
    Gaganbawada: ['Gaganbawada', 'Other Village'],
    Bhudargad: ['Bhudargad', 'Other Village'],
    Ajra: ['Ajra', 'Other Village'],
    Gadhinglaj: ['Gadhinglaj', 'Other Village'],
    Chandgad: ['Chandgad', 'Other Village']
  },
  Pune: {
    Haveli: ['Pune', 'Kharadi', 'Wagholi', 'Other Village']
  },
  'Mumbai City': {
    'Mumbai City': ['Mumbai', 'Other Village']
  },
  'Mumbai Suburban': {
    'Mumbai Suburban': ['Mumbai', 'Andheri', 'Bandra', 'Other Village']
  }
}

function createLocationHierarchy(): LocationHierarchy {
  return Object.fromEntries(
    Object.entries(indiaDistricts).map(([state, districts]) => [
      state,
      Object.fromEntries(
        districts.map(district => [
          district,
          state === 'Maharashtra' && maharashtraTalukas[district]
            ? maharashtraTalukas[district]
            : { [district]: [district, 'Other Village'] }
        ])
      )
    ])
...
export const indiaLocations = createLocationHierarchy()
export type IndianState = keyof typeof indiaDistricts
